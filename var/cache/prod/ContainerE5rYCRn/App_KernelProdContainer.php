...
class App_KernelProdContainer extends Container
{
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('3a+e3pWBxz', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    protected function getMonolog_Handler_FilterForErrorsService()
    {
        ...
        return $this->privates['monolog.handler.filter_for_errors'] = new \Monolog\Handler\FingersCrossedHandler($a, new \Monolog\Handler\FingersCrossed\ErrorLevelActivationStrategy(400), 0, true, true, NULL);
    }
    ...
    {
        $this->privates['monolog.handler.main'] = $instance = new \Monolog\Handler\RotatingFileHandler((\dirname(__DIR__, 3).'/log/prod.log'), 3, 100, true, NULL, false);
